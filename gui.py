...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About Healthcare bot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Healthcare bot",'Healthcare bot is a chatbot for answering health queries\nIt is develop in python\nGUI is based on Tkinter\nIt can answer questions regarding health problem to the user')

    def about(self):
        tkinter.messagebox.showinfo("Healthcare bot Developers","1.Divya Gaur\n2.Devendra\n3.Abhinav\n4.Uttam")
